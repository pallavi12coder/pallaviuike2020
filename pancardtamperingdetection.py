# -*- coding: utf-8 -*-
"""PanCardTamperingDetection.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ta7xdreFLKtGsrp-5Nhv6fi_3gy7m3b9
"""
...
The goal of this project is to develop a system that can identify if a PAN card has been tampered with using computer vision techniques, allowing organizations to verify the authenticity of PAN cards submitted by their employees or customers, ensuring that the provided ID is genuine and not altered in any way.
...
#Image size, in pixels. The size is given as 2 - tupe(widyh, height),
